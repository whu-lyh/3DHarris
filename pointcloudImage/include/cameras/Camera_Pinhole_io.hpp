...
void PCImage::cameras::Pinhole_Intrinsic::save( Archive & ar ) const
{
...
*/
template <class Archive>
void PCImage::cameras::Pinhole_Intrinsic::load( Archive & ar )
{
...
CEREAL_REGISTER_TYPE_WITH_NAME(PCImage::cameras::Pinhole_Intrinsic, "pinhole");
CEREAL_REGISTER_POLYMORPHIC_RELATION(PCImage::cameras::IntrinsicBase, PCImage::cameras::Pinhole_Intrinsic);
