...
namespace vpfbr{
	...
	float parameter_l2 = 2.0; //1.0;
	float parameter_k1 = 5.0; //5.0;
	float parameter_k2 = 2.0; //2.0;
	//threshold of normal vector
	float normal_vector_threshold1 = 5.0; //5
	float normal_vector_threshold2 = 8.0; //8
	//voxel size
	float face_voxel_size = 0.5; //1.0;
	...
	float curvature_threshold = 0.05; // 0.05
	//select the number or size of planes
	//float select_plane_size=0;
	float select_plane_number = 15; //15
	...
	float fine_verify_voxel_size = 0.5; //0.5
	float fine_verify_number = 50; //50
