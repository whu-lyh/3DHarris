...
Pose<double> PSUtility::EvaluatePS(double u,
                                                  ...
                                                  const Eigen::Vector3d &V3)
{
    ...
    Eigen::Vector3d velocity_in_world_frame = dotBeta1 * (V1 - V0) +
                                              dotBeta2 * (V2 - V1) +
                                              dotBeta3 * (V3 - V2);
                                                    ...
                                                    const Eigen::Vector3d &gravity)
{
    ...
    Eigen::Vector3d accel_in_body_frame = R_WI.transpose() * (accel_in_world_frame + gravity);
