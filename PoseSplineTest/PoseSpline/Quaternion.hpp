 ...
 * @LastEditTime: 2023-03-04 09:56:14
 * @FilePath: \PoseSpline\include\PoseSpline\Quaternion.hpp
 * @Description: quaternion related function inherited from okvis framework
 */
#ifndef QUATERNION_H
#define QUATERNION_H
