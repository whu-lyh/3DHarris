 ...
 * @LastEditTime: 2023-03-04 22:45:27
 * @FilePath: \PoseSpline\include\PoseSpline\VectorSplineSampleError.hpp
 * @Description: VectorSplineSampleError
 */
...
{
public:
    VectorSplineSampleError(const double &t_meas, const Eigen::Matrix<double, Dim, 1> &V_meas) : t_meas_(t_meas), V_Meas_(V_meas)
    {
    }
