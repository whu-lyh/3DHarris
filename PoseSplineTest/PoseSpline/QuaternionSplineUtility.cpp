                                          ...
                                          const Quaternion &Q3)
{
    ...
    dot_dot_q = quatLeftComp(Q0) * (part11 + part12 + part13 + part21 + part22 + part23 + part31 + part32 + part33);
                                                     ...
                                                     const Quaternion &extrinsicQ)
{
    ...
    Eigen::Matrix4d J;
    J = quatLeftComp(invExtQ) * quatLeftComp(A) * quatRightComp(extrinsicQ) - quatLeftComp(invExtQ) * quatRightComp<double>(quatLeftComp(A) * extrinsicQ);
