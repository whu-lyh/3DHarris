...
int main_clipper ( int argc, char* argv [] )
{
	int display_width = 800, display_height = 600;
	bool show_cords = true;//true;//  //don't this if there are hundreds or thousands of coords :)
	...
	subject [0] [0].x = 0;   subject [0] [0].y = 50;
	subject [0] [1].x = 100; subject [0] [1].y = 50;
	subject [0] [2].x = 100; subject [0] [2].y = 100;
	subject [0] [3].x = 0;   subject [0] [3].y = 100;
	subject [0] [3].x = 20;   subject [0] [3].y = 400;
	subject [0] [3].x = 60;   subject [0] [3].y = 80;
