...
ScalarType Neighbourhood::computeCurvature(const CCVector3& P, CurvatureType cType)
{
	...
	case MEAN_CURV:
		{
			//we get 2D1/2=2.5D quadric parameters
			...
			//The variable of quadric curve model
			...
			const PointCoordinateType  fx	= b + (d*2) * Q.u[X] + (e  ) * Q.u[Y];	// b+2d*X+eY, u is the union of Tuple3Tpl
	...
	case NORMAL_CHANGE_RATE:
		{
			...
			//here should reobtain the order of the eigValues?
